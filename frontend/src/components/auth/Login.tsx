            ...
            <div className="relative z-10 w-full max-w-sm animate-slide-up">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase">
                        Gym<span className="text-primary">Track</span><span className="text-slate-400">Pro</span>
                    </h1>
                    <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-1">Evoluciona tu potencial</p>
                </div>

                {/* Form card */}
                <div className="bg-white/80 backdrop-blur-xl border border-slate-100 rounded-[2.5rem] p-8 shadow-2xl">
                    <h2 className="text-xl font-black text-slate-900 mb-1 uppercase tracking-tight">Iniciar sesión</h2>
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-6">Bienvenido atleta</p>

                    {successMsg && !error && (
                        <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 text-xs font-bold p-3.5 rounded-xl mb-5 flex items-center gap-2">
